...
if args.features == 'ComParE_2016':
    ...
    sfn = "ComParE_2016/" + args.split_type
elif args.features == 'eGeMAPS':
    fn = 'egemaps/v01b/eGeMAPSv01b.conf'
    sfn = "eGeMAPS/" + args.split_type
elif args.features == 'IS10_paraling':
    fn = 'is09-13/IS10_paraling.conf'
    sfn = "IS10_paraling/" + args.split_type
elif args.features == 'IS09_emotion':
    fn = 'is09-13/IS09_emotion.conf'
    sfn = "IS09_emotion/" + args.split_type
elif args.features == 'IS10_paraling_compat':
    fn = 'is09-13/IS10_paraling_compat.conf'
    sfn = "IS10_paraling_compat/" + args.split_type
...
def Walk_Folders(wave_root, save_root, feature_type):
    ...
    for mfile in mfiles:
        ...
        # 每次追加在最后一行
        Extract_From_Wav(wave_file, "Data/open_smile/temp.csv", 'temp.csv')
        f = open("Data/open_smile/temp.csv", 'r')
...
if os.path.exists("Data/open_smile/temp.csv"):
    os.remove("Data/open_smile/temp.csv")
