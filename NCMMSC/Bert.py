...
from utils.script_dataset import get_dataloader
    ...
    for epoch in range(EPOCHES):
        ...
        if avg_val_loss <= val_loss_min:
            ...
            torch.save(model.state_dict(),
                       'save_models/short_task/random3/robert.pth')
...
def test(model, test_loader, lossfuction, DEVICE):
    ...
    print("Running Test...")
    t0 = time.time()
    state_dict = torch.load('save_models/short_task/random3/robert.pth')
...
# get dataloader
train_loader = get_dataloader('short_csvs/train.csv')
val_loader = get_dataloader('short_csvs/val.csv',
                             shuffle=False)
test_loader = get_dataloader('short_csvs/test.csv',
                             shuffle=False)
